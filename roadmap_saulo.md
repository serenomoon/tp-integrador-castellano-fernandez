...
- [x] **2.3. Endpoints API JSON (Respuestas en formato JSON)**:
  ...
  - [X] `GET /api/ventas` (historial de ventas con productos - Eager Loading).
- [X] **2.4. Middlewares de Validación**:
...
- [x] **3.2. Dashboard de Administración (`/admin/dashboard`)**:
